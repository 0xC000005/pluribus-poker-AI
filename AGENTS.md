...
- The active research target is neural regret-field resolving: learn public-belief regret/policy fields that warm-start CFR+/resolving, then let search correct them. Do not revive hard learned leaf/successor value replacement, final-distribution policy mixing sweeps, or policy argmax imitation as the mainline without a completed methodology review and root-disjoint resolver gate.
