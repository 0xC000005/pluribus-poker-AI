#!/usr/bin/env python3
"""Train a stochastic soft-Q actor from compiled native population replay."""
...
from poker_ai.research.compiled_replay_soft_q_actor import (  # noqa: E402
    run_compiled_replay_soft_q_actor,
)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--policy-train-steps", type=int, default=500)
...
def main(argv: Sequence[str] | None = None) -> dict:
    ...
    metrics = run_compiled_replay_soft_q_actor(
