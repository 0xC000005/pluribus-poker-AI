#!/usr/bin/env python3
"""Score observed Slumbot actions for revealed bot hands."""
...
from poker_ai.research.slumbot_trace_action_likelihood import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Measure observed Slumbot action likelihood for revealed hands."
    )
